...
public final class ActivityTeacherLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText etTeacherId;

  @NonNull
  public final TextView tvLoginTitle;

  private ActivityTeacherLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText etPassword, @NonNull EditText etTeacherId, @NonNull TextView tvLoginTitle) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.etPassword = etPassword;
    this.etTeacherId = etTeacherId;
  ...
  public static ActivityTeacherLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etTeacherId;
      EditText etTeacherId = ViewBindings.findChildViewById(rootView, id);
      if (etTeacherId == null) {
        break missingId;
      }
