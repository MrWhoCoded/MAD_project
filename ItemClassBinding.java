...
public final class ItemClassBinding implements ViewBinding {
  ...
  private ItemClassBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvClassCode,
  ...
  public static ItemClassBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tvClassCode;
      TextView tvClassCode = ViewBindings.findChildViewById(rootView, id);
      if (tvClassCode == null) {
        break missingId;
      }
      ...
      return new ItemClassBinding((ConstraintLayout) rootView, tvClassCode, tvClassName);
    }
